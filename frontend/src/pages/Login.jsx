        ...
        <div className="min-h-screen flex items-center justify-center px-4 py-12">
            ...
            <div className="w-full max-w-md animate-slide-up">
                ...
                <div className="text-center mb-9">
                    ...
                    <p className="text-slate-400 mt-2 text-sm md:text-base">Master LeetCode with spaced repetition</p>
                </div>

                <div className="card shadow-2xl border-white/5 relative overflow-hidden">
                    <div className="absolute -top-20 -right-20 w-56 h-56 rounded-full bg-brand-600/10 blur-2xl" />
